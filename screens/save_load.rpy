...
screen load():
    ...
    use file_slots(_("IELĀDĒT"))


screen file_slots(title):

    default page_name_value = FilePageNameInputValue(
        pattern=_("Lapa {}"), auto=_(""),
        quick=_("Ātrie saglabājumi"))
        ...
        vbox:
            ...
            if config.has_sync:
                if CurrentScreenName() == "save":
                    textbutton _("Augšupielādēt sinhronizāciju"):
                        action UploadSync()
                else:
                    textbutton _("Lejupielādēt sinhronizāciju"):
                        action DownloadSync()
